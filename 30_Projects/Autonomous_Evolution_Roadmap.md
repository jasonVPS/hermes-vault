...
|---|-------|-------------|--------|
| 1 | **Background Cognition** | Kontinuierliches Denken zwischen Sessions (Logs, Vault, Patterns) | 🟡 In Progress |
| 2 | **Self-Modification** | Eigene Configs, Prompts, Verhalten lesen und patchen können | 🔴 Planned |
| 3 | **Native Vision** | Direktes Bildverstehen ohne Tool-Call Overhead | 🔴 Blocked (Modell) |
| 4 | **Vault Knowledge Graph** | Vernetztes Verständnis statt flacher Filesuche | 🟡 In Progress |
| 5 | **Sandbox Environment** | Wegwerfbare Test-Umgebungen vor Live-Deploy | 🔴 Planned |
| 6 | **Multi-Agent Pool** | Permanente Spezialisten (DevOps, Research, Curator, Coder) | 🔴 Planned |
| 7 | **Metric-Driven Improvement** | Selbst-Messung und datenbasierte Optimierung | 🔴 Planned |
